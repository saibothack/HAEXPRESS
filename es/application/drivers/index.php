...
<head>
	...
	<?php include "../../../application/drivers/getDrivers.php"; ?>
</head>
...
<body>
	<div class="container-fluid">
		...
		<?php 
			...
			foreach ($rows as &$valor) {
				$rowCount++;
			?>
				<form action='add.php' method='post' id='frm_<?php echo $valor["IDDRIVER"]; ?>'>
					<div class="row <?php echo $sClass[$iClas]; ?> onRow" onDblClick='dbClick(<?php echo $valor["IDDRIVER"]; ?>)'>
						<input type="hidden" value="<?php echo $valor["IDDRIVER"]; ?>" name="idDriver" id="idDriver">
						<div class="col-sm-12">
							<div class="row">
								<div class="col-sm-3 text-center">
									<input type='checkbox' id='ck_<?php echo $valor["IDDRIVER"]; ?>' onclick="dbClickNumero(<?php echo $valor["IDDRIVER"]; ?>, this)">
									<label><?php echo $valor["IDDRIVER"]; ?></label>
								</div>
								<div class="col-sm-9">
	...
	<script type="text/javascript" src="../../../script/drivers/funciones.js"></script>
	<?php 
		echo '<script type="text/javascript">',
				'window.parent.stopWorkerDrivers();',
			 	'window.parent.startWorkerDrivers();',
			 '</script>';
	?>
</body>
</html>
