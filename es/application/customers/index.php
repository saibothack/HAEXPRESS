...
<head>
	...
	<?php include "../../../application/customers/getCustomers.php"; ?>
</head>
<body>
	<div class="container-fluid">
		...
		<?php 
			...
			foreach ($rows as &$valor) {
				$rowCount++;
			?>
				<form action='add.php' method='post' id='frm_<?php echo $valor["IDCUSTOMER"]; ?>'>
					<div class="row <?php echo $sClass[$iClas]; ?> onRow" onDblClick='dbClick(<?php echo $valor["IDCUSTOMER"]; ?>)'>
						<input type="hidden" value="<?php echo $valor["IDCUSTOMER"]; ?>" name="idCustomers" id="idCustomers">
						<div class="col-sm-12">
							<div class="row">
								<div class="col-sm-3 text-center">
									<input type='checkbox' id='ck_<?php echo $valor["IDCUSTOMER"]; ?>' onclick="dbClickNumero(<?php echo $valor["IDCUSTOMER"]; ?>, this)">
									<label><?php echo $valor["IDCUSTOMER"]; ?></label>
								</div>
								<div class="col-sm-9">
	...
	<script type="text/javascript" src="../../../script/customers/index.js"></script>
</body>
</html>
