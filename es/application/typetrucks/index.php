...
<head>
	...
	<?php include "../../../application/typetrucks/getTypeTruck.php"; ?>
</head>
...
<body>
	<div class="container-fluid">
		...
		<?php 
			...
			foreach ($rows as &$valor) {
				$rowCount++;
			?>
				<form action='add.php' method='post' id='frm_<?php echo $valor["IDTYPETRUCK"]; ?>'>
					<div class="row <?php echo $sClass[$iClas]; ?> onRow" onDblClick='dbClick(<?php echo $valor["IDTYPETRUCK"]; ?>)'>
						<input type="hidden" value="<?php echo $valor["IDTYPETRUCK"]; ?>" name="idTypeTruck" id="idTypeTruck">
						<div class="col-sm-12">
							<div class="row">
								<div class="col-sm-3 text-center">
									<input type='checkbox' id='ck_<?php echo $valor["IDTYPETRUCK"]; ?>' onclick="dbClickNumero(<?php echo $valor["IDTYPETRUCK"]; ?>, this)">
									<label><?php echo $valor["IDTYPETRUCK"]; ?></label>
								</div>
								<div class="col-sm-9">
									<label><?php echo $valor["TTNAME"]; ?></label>
								</div>
							</div>
						</div>
					</div>	
	...
	<script type="text/javascript" src="../../../script/typetrucks/funciones.js"></script>
</body>
</html>
