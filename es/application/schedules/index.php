...
<body>
	<div class="container-fluid">
		...
		<?php 
			...
			foreach ($rows as &$valor) {
				$rowCount++;
			?>
				<form action='add.php' method='post' id='frm_<?php echo $valor["IDSCHEDULE"]; ?>'>
					<div class="row <?php echo $sClass[$iClas]; ?> onRow" onDblClick='dbClick(<?php echo $valor["IDSCHEDULE"]; ?>)'>
						<input type="hidden" value="<?php echo $valor["IDSCHEDULE"]; ?>" name="idSchedule" id="idSchedule">
						<div class="col-sm-12">
							<div class="row">
								<div class="col-sm-3 text-center">
									<input type='checkbox' id='ck_<?php echo $valor["IDSCHEDULE"]; ?>' onclick="dbClickNumero(<?php echo $valor["IDSCHEDULE"]; ?>, this)">
									<label><?php echo $valor["IDSCHEDULE"]; ?></label>
								</div>
								<div class="col-sm-9">
	...
	<script type="text/javascript" src="../../../script/schedules/funciones.js"></script>
</body>
</html>
